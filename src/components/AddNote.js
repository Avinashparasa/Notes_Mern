...
function AddNote() {
  ...
  const handleAddNote = (e) => {
    ...
    addNote(note.title, note.description, note.tag, note.audio, note.image,note.image1,false);
    setNote({ title: "", description: "", tag: "", audio: null, image: null ,image1:null,favourite:false});
    setAudioURL(null);
  };
